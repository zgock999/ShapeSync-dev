...
the API change described in step 4. The Asset Serialization Mode part of step
6 still requires a change in both template routes: new projects default to
...
```text
https://github.com/zgock999/ShapeSync-dev.git?path=Packages/net.zgock-lab.shapesync#0.2.0-preview10
```

The `?path=` subfolder must appear before `#0.2.0-preview10`. The revision is
...
```text
https://github.com/zgock999/ShapeSync-dev.git?path=Packages/net.zgock-lab.shapesync.vrm#0.2.0-preview10
```
